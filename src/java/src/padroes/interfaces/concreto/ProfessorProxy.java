 ...
 * @author Marcos Agnes
 */
public class ProfessorProxy implements GerenciarPessoa, GerenciarReservas, GerenciarSala, GerenciarDecoradores {
...
//        }
    ...
    public dao.entity.Pessoa criarPessoa(String nome, String tp) {
        new Redirecionador().erro("vc não tem permição de criar novos cadastros!");
        return null;
    }
    ...
    public void liberarReserva(int id) {
        // Liberar a reserva no banco de dados
    }
